...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/Fahrihosting1/pterodactyl-installer"}
...
welcome() {
  ...
  output ""
  output "Copyright (C) 2018 - 2024, GaraXyz - Assisten  <fahrihosting@prytznet.se>"
  output "https://github.com/Fahrihosting1/pterodactyl-installer"
  output ""
